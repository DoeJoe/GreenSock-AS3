 ...
 */
	public class StarlingTransformMatrixPlugin extends TweenPlugin {
		...
		public function StarlingTransformMatrixPlugin() {
			super("transformStarlingMatrix,x,y,scaleX,scaleY,rotation,width,height,transformAroundPoint,transformAroundCenter");
		}
		
		/** @private **/
		override public function _onInitTween(target:Object, value:*, tween:TweenLite):Boolean {
			_target = target as DisplayObject;
			_matrix = (target as DisplayObject).transformationMatrix;
